...
class HalfCheetahParamsBound(Enum):
    ...
    RARL = {
        ...
        "backthighforce_x": [-3.0, 3.0],
        "backthighforce_y": [-3.0, 3.0],
        "backthighforce_z": [-3.0, 3.0],
        "backshinforce_x": [-3.0, 3.0],
        "backshinforce_y": [-3.0, 3.0],
        "backshinforce_z": [-3.0, 3.0],
        "backfootforce_x": [-3.0, 3.0],
        "backfootforce_y": [-3.0, 3.0],
        "backfootforce_z": [-3.0, 3.0],
        "forwardthighforce_x": [-3.0, 3.0],
        "forwardthighforce_y": [-3.0, 3.0],
        "forwardthighforce_z": [-3.0, 3.0],
        "forwardshinforce_x": [-3.0, 3.0],
        "forwardshinforce_y": [-3.0, 3.0],
        "forwardshinforce_z": [-3.0, 3.0],
        "forwardfootforce_x": [-3.0, 3.0],
        "forwardfootforce_y": [-3.0, 3.0],
        "forwardfootforce_z": [-3.0, 3.0],
    }
