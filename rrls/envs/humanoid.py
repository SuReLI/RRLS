...
class HumanoidStandupParamsBound(Enum):
    ...
    RARL = {
        ...
        "lwaisforce_x": [-3.0, 3.0],
        "lwaisforce_y": [-3.0, 3.0],
        "lwaisforce_z": [-3.0, 3.0],
        "pelvisforce_x": [-3.0, 3.0],
        "pelvisforce_y": [-3.0, 3.0],
        "pelvisforce_z": [-3.0, 3.0],
        "rightthighforce_x": [-3.0, 3.0],
        "rightthighforce_y": [-3.0, 3.0],
        "rightthighforce_z": [-3.0, 3.0],
        "rightshinforce_x": [-3.0, 3.0],
        "rightshinforce_y": [-3.0, 3.0],
        "rightshinforce_z": [-3.0, 3.0],
        "rightfootforce_x": [-3.0, 3.0],
        "rightfootforce_y": [-3.0, 3.0],
        "rightfootforce_z": [-3.0, 3.0],
        "leftthighforce_x": [-3.0, 3.0],
        "leftthighforce_y": [-3.0, 3.0],
        "leftthighforce_z": [-3.0, 3.0],
        "leftshinforce_x": [-3.0, 3.0],
        "leftshinforce_y": [-3.0, 3.0],
        "leftshinforce_z": [-3.0, 3.0],
        "leftfootforce_x": [-3.0, 3.0],
        "leftfootforce_y": [-3.0, 3.0],
        "leftfootforce_z": [-3.0, 3.0],
        "rightupperarmforce_x": [-3.0, 3.0],
        "rightupperarmforce_y": [-3.0, 3.0],
        "rightupperarmforce_z": [-3.0, 3.0],
        "rightlowerarmforce_x": [-3.0, 3.0],
        "rightlowerarmforce_y": [-3.0, 3.0],
        "rightlowerarmforce_z": [-3.0, 3.0],
        "leftupperarmforce_x": [-3.0, 3.0],
        "leftupperarmforce_y": [-3.0, 3.0],
        "leftupperarmforce_z": [-3.0, 3.0],
        "leftlowerarmforce_x": [-3.0, 3.0],
        "leftlowerarmforce_y": [-3.0, 3.0],
        "leftlowerarmforce_z": [-3.0, 3.0],
    }
